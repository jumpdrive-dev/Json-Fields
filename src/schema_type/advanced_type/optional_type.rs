...
use crate::schema_type::advanced_type::AnyOfType;
...
mod tests {
    ...
    fn optional_type_is_resolved_correctly() {
        ...
        assert_eq!(optional_type.validate(&json!(10)), Err(SchemaTypeValidationError::BasicTypeValidationError(BasicTypeValidationError::IncorrectType(BasicType::String, json!(10)))));
    }
}
